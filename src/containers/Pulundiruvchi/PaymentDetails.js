                            ...
                            <TouchableOpacity
                                ...
                                style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between', marginVertical: 10}}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', width: '90%' }}>
                                        ...
                                        <Text style={{color: darkmode ? '#fff' : '#000'}}><Text style={{fontWeight:'600', color: darkmode ? '#fff' : '#000'}}>{moment(items.paymentDate).format('ll')}</Text> uchun to’lov amalga oshirildi</Text>
                                        </View>
...

                                {
                                    ...
                                    <View style={[Css(darkmode).mx10, Css(darkmode).flex, Css(darkmode).between, Css(darkmode).itemscenter]}>
                                        <View>
                                            <Text style={Css(darkmode).h5}>{t('sana_')}</Text>
                                        </View>
                                        <View>
                                                <Text style={[Css(darkmode).bold, Css(darkmode).h5]}>16, mart</Text>
                                        </View>
                                    </View>

                                    <View style={[Css(darkmode).mx10, Css(darkmode).flex, Css(darkmode).between, Css(darkmode).itemscenter]}>
                                        <View>
                                            <Text style={Css(darkmode).h5}>{t('kim_toladi')}</Text>
                                        </View>
                                        <View>
                                                <Text style={[Css(darkmode).bold, Css(darkmode).h5]}>Sadulla Kobiljonov</Text>
                                        </View>
                                    </View>

                                    <View style={[Css(darkmode).mx10, Css(darkmode).flex, Css(darkmode).between, Css(darkmode).itemscenter]}>
                                        <View>
                                            <Text style={Css(darkmode).h5}>{t('which_month')}</Text>
                                        </View>
                                        <View>
                                                <Text style={[Css(darkmode).bold, Css(darkmode).h5]}>Mart oyi uchun</Text>
                                        </View>
                                    </View>

                                    <View style={[Css(darkmode).mx10, Css(darkmode).flex, Css(darkmode).between, Css(darkmode).itemscenter]}>
                                        <View>
                                            <Text style={Css(darkmode).h5}>{t('qanch_toladi')}</Text>
                                        </View>
                                        <View>
                                                <Text style={[Css(darkmode).bold, Css(darkmode).h5]}>$100</Text>
                                        </View>
                                    </View>
                                        ...
                                        <View>
                                            {
                                                items.paid == false ? (
                                                    <TouchableOpacity 
                                                    onPress={() => NavigationService.navigate('PulUndiruvchiTolovQabulQilish', {
                                                        "id" : props.route.params.payments._id,
                                                        "loanid" : items.payId,
                                                        "remainingMoney" : props.route.params.payments.remainingMoney
                                                    })}
                                                    style={{backgroundColor:'#FBC100', height: 30,alignItems:'center', justifyContent:'center', paddingHorizontal: 10, borderRadius: 10}}>
